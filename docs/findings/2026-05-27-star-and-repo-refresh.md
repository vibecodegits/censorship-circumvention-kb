...
- Self-managed orchestration/panels and clients: MoaV, Hiddify Manager, 3x-ui, Throne, and sing-box-adjacent tooling.
...
| [hiddify/Hiddify-Manager](https://github.com/hiddify/Hiddify-Manager) | `v12.3.1`, 2026-05-26 | Active self-managed orchestration/panel layer; track as orchestration, not a single transport. |
| [MHSanaei/3x-ui](https://github.com/MHSanaei/3x-ui) | `v3.1.0`, 2026-05-23 | Active self-managed Xray-oriented panel/user manager; same broad category as MoaV and Hiddify. |
...
| [MHSanaei/3x-ui](https://github.com/MHSanaei/3x-ui) | Pushed 2026-05-28 UTC | Self-managed Xray panel/user management remains active. |
