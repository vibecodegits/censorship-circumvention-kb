...
These cards describe reusable method families. They intentionally avoid raw live configs, IP lists, UUIDs, private relay URLs, and credentials.
...
- [Self-managed multi-protocol orchestration and panels](multi-protocol-orchestration.md)
...
- [Self-managed origins, panels, and tunnel infrastructure](self-hosted-origin-and-cloudflare-tunnel.md)
- [Twoman host-preserving relay](twoman-host-preserving-relay.md)
- [Vercel XHTTP relay](vercel-xhttp-relay.md)
